...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $gambar_dest = "../home/uploads/gambar/" . basename($gambar);


    // Lakukan upload file poster dan banner
    if (move_uploaded_file($poster_tmp, $poster_dest) && move_uploaded_file($gambar_tmp, $gambar_dest)) {
        ...
        $stmt->bind_param("sssssss", $judul, $sinopsis, $duration, $poster, $gambar, $actor, $direktor);
